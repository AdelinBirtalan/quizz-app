const questions = [
    {
        ...
        answers: [
            { text: "Vatican Museums", correct: false},
            { text: "Louvre Museum", correct: true},
            { text: "The British Museum", correct: false},
            { text: "National Gallery of Art", correct: false},
        ]
    },
    {
        question: "What are elephant tusks made of?",
        answers: [
            { text: "Plastic", correct: false},
            { text: "Fiber", correct: false},
            { text: "Leather", correct: false},
            { text: "Ivory", correct: true},
        ]
    },
    {
        question: "What two primary colors can be mixed to make purple?",
        answers: [
    ...
    {
        question: "How many legs do insects typically have?",
        answers: [
